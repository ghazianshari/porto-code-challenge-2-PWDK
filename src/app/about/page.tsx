...
export default function About() {
  return (
    <div className="container mx-auto max-w-7xl space-y-14 py-10">
      ...
      >
        <div className="space-y-6">
          ...
          <p className="text-secondary leading-relaxed">
            ...
            reflects exactly what I’ve built.{" "}
        ...
        <div className="space-y-6">
          ...
          <p className="text-secondary leading-relaxed">
            ...
            and a lover of rap, indie, classic, and rock music. Not a cat
            person, but hey — I do have a cat.
          </p>
        </div>
      </motion.section>
        ...
        >
          ...
          >
            <div className="flex gap-2">
              <FaCode className="mb-4 h-8 w-8 text-blue-500 dark:text-yellow-100" />
          ...
          >
            <div className="flex gap-2">
              <FaLaptopCode className="mb-4 h-8 w-8 text-blue-500 dark:text-yellow-100" />
              <h3 className="text-primary mb-2 pt-0.5 text-xl font-semibold">
                Backend
              </h3>
            </div>
          ...
          >
            <div className="flex gap-2">
              <FaGraduationCap className="mb-4 h-8 w-8 text-blue-500 dark:text-yellow-100" />
              <h3 className="text-primary mb-2 pt-0.5 text-xl font-semibold">
                Tools & Others
              </h3>
            </div>
          ...
          >
            ...
            >
              ...
              <ul className="text-secondary marker:text-primary list-inside list-disc space-y-3 leading-relaxed">
                ...
                <li>
                  Evaluate vendor performance and ensure services meet
                  established standards and contractual agreements.
                </li>
                <li>
                ...
                <li>
                  Ensure access control procedures align with company policies
            ...
            >
              ...
              <p className="mb-2 font-semibold text-blue-500">
                Paralegal • Internship • 2021
              </p>
              <ul className="text-secondary marker:text-primary list-inside list-disc space-y-3 leading-relaxed">
                <li>
                  Researching and compiling relevant regulations for a
                  particular compliances case
                </li>
